const Vision= () => {
  return (
    <section id="Visión" class="bg-gray-100 py-16 mt-10">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-4">
            ...
            <h2 class="text-3xl font-extrabold text-gray-900">Nuestra Visión</h2>
        </div>
        <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div>
                <div class="flex items-center justify-center h-15 w-15 rounded-md bg-indigo-500 text-white">
                ...
                <div class="mt-5">
                    <h3 class="text-lg font-medium text-gray-900">Misión</h3>
                    <p class="mt-2 text-base text-gray-500">Difundir, preservar y promover la riqueza de la música cubana, conectando a artistas, creadores y 
            ...
            <div>
                ...
                <div class="mt-5">
                    ...
                    <p class="mt-2 text-base text-gray-500">Autenticidad, Colaboración, Innovación, Inclusión, Excelencia, Respeto.</p>
                </div>
            </div>
            <div>
                <div class="flex items-center justify-center h-15 w-15 rounded-md bg-indigo-500 text-white">
                ...
                <div class="mt-5">
                    <h3 class="text-lg font-medium text-gray-900">Visión</h3>
                    <p class="mt-2 text-base text-gray-500">Ser la plataforma de referencia internacional para la música cubana, impulsando su reconocimiento y
